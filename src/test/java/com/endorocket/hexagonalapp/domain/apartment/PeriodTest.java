...
class PeriodTest {
	...
	void shouldReturnAllDaysBetweenStartAndEnd(LocalDate start, LocalDate end, List<LocalDate> expected) {
	...
	private static Stream<Arguments> daysBetweenStartAndEnd() {
		return Stream.of(
			...
			Arguments.of(
				...
				asList(LocalDate.of(2020, 5, 5), LocalDate.of(2020, 5, 6), LocalDate.of(2020, 5, 7), LocalDate.of(2020, 5, 8), LocalDate.of(2020, 5, 9), LocalDate.of(2020, 5, 10)))
		);
	}
