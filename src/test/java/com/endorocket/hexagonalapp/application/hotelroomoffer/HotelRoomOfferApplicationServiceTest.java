...
class HotelRoomOfferApplicationServiceTest {
  private static final String HOTEL_ID = "456";
  ...
  private static final LocalDate START_YEAR_LATER = LocalDate.of(2041, 10, 11);
  ...
  private final HotelRoomOfferApplicationService service = new HotelRoomOfferApplicationService(hotelRepository, hotelRoomOfferRepository);
  ...
  void shouldRecognizePriceLowerThanZero() {
    givenExistingHotelRoom();
    HotelRoomOfferDto dto = new HotelRoomOfferDto(HOTEL_ID, ROOM_NUMBER, HOTEL_ROOM_ID, BigDecimal.valueOf(-4), START, END);
