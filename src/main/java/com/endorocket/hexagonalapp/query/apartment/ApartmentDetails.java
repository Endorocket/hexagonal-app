...
public class ApartmentDetails {
	...
	static ApartmentDetails withHistory(ApartmentReadModel apartmentReadModel, ApartmentBookingHistoryReadModel bookingHistory) {
		return new ApartmentDetails(apartmentReadModel, bookingHistory);
	}
